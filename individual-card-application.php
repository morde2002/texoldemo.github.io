...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Individual Card Application Form Submission';

    // Customize email content
    $mail->Body = "
        <h1>Individual Loyalty Card Application Form Submission</h1>
    ...
    // Send email
    if ($mail->send()) {
        echo '<h1>You Have Successfully Registered for the Texol Individual Card
