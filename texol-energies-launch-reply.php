...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Texol-Energies-launch Comment Submission';
    ...
    ";
    if($mail->send()){
           header('Location: commented-successfully-texol-launch.html'); // Redirect to 'thank you' page. Make sure you have it
       } else {
